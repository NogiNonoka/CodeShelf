 ...
 * @FilePath            : /CodeShelf/MathTheory/ElementaryNumberTheory_ChinaRemainderTheorem.cpp
...
int exgcd(int a, int b, int& x, int& y) {
    // Solve Congruent Liner Equation: ax + by == gcd(a, b), ax = gcd(a, b) (mod
    // b) Minimum Positive Integer Solution: t = b / gcd(a, b), x = (x % t + t)
    // % t
    if (b == 0) {
        x = 1;
        y = 0;
